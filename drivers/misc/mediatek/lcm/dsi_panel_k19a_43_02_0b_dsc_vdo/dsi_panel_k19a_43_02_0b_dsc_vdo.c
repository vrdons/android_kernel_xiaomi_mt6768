...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[2].fps = 3000;/*real fps * 100, to support float*/
	dfps_params[2].vact_timing_fps = 9000;/*real vact timing fps * 100*/
	/* dfps_params[2].PLL_CLOCK = xx; */
	/* dfps_params[2].data_rate = xx; */
	dfps_params[2].vertical_frontporch = 2210;
	dfps_params[2].vertical_frontporch_for_low_power = 2524;
